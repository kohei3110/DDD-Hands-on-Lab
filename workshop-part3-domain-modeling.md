...
各ドメインイベントを引き起こすコマンドを特定：

| ドメインイベント | コマンド | アクター（実行者） |
|-----------------|----------|-------------------|
| 見込み客が登録された | 見込み客を登録する | マーケティング担当者 |
| AIが顧客ニーズを分析した | AIニーズ分析を実行する | AIエージェント |
| 提案資料が自動生成された | 提案資料を生成する | 提案書生成システム |
| 商談が実施された | 商談を実施する | 営業担当者 |
| 受注が確定した | 受注を確定する | 営業マネージャー |
